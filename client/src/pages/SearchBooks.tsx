...
import { SAVE_BOOK } from '../service/mutations';
...
const SearchBooks = () => {
  ...
  // Function to handle saving a book to our database using the SAVE_BOOK mutation
  const handleSaveBook = async (bookId: string) => {
    ...
    try {
      // Execute the SAVE_BOOK mutation with the book data
      await saveBookMutation({
        variables: { book: bookToSave }
      });

      // If book is successfully saved to user's account, save book id to state
